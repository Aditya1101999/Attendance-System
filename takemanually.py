...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == "":
            ...
            STUDENT_ENTRY = tk.Entry(
                MFW, width=20, bg="grey", fg="blue", font=("times", 23, " bold ")
            )
            ...
            def create_csv():
                df = pd.DataFrame(d)
                csv_name = (
                    "/Users/adi/Downloads/Attendance-Management-system-using-face-recognition-master/FBAS/Attendance(Manually)//"
                    + subb
                    + "_"
                    + Date
                    + "_"
            ...
            def attf():
                ...
                subprocess.Popen(
                    'explorer /select,"/Users/adi/Downloads/Attendance-Management-system-using-face-recognition-master/FBAS/Attendance(Manually)"'
                )
    ...
    SUB_ENTRY = tk.Entry(
        sb, width=20, bg="yellow", fg="blue", font=("times", 23, " bold ")
    )
